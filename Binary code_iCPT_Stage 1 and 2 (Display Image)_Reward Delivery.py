...
def apply_formulas(df):
    ...
    # Get all Display Image indices
    display_indices = df[is_display_image].index
    
    # Get all outcome events (group 6)
    is_outcome = (df.iloc[:, 2] == "Condition Event") & 5<=(df.iloc[:, 5]<=6 )
...
if __name__ == "__main__":
    ...
    input_path = "/Users/meiramaria/Documents/Data/Meira photometry/CPT - Dopamine/CPT/Stage 2 - Last day/F5/untitled folder"
    output_path = "/Users/meiramaria/Documents/Data/Meira photometry/CPT - Dopamine/CPT/Stage 2 - Last day/F5/untitled folder"
